local ShopRawItemsList = {
    ...
    softwarePlayerHealth = {
        type = "software",
        shopDisplayName = {"item-name.prime_intergalactic_delivery-software_player_health"},
        shopDisplayDescription = {"item-shop-description.prime_intergalactic_delivery-software_player_health"},
        picture = "item/prime_intergalactic_delivery-software_player_health",
        item = "prime_intergalactic_delivery-software_player_health",
        printName = {"item-effect-name.prime_intergalactic_delivery-software_player_health"},
        quantity = 1,
        priceCalculationInterfaceName = "Shop.CalculateSoftwarePrice",
        bonusEffectType = "core",
        bonusEffect = function(removing)
